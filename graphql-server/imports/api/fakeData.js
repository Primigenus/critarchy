const users = [
  {
    ...
    artCreated: [{id: "101"}, {id: "102"}],
    sketchbooksCreated: [{id: "11"}],
    critiquesCreated: [{id: "1001"}, {id: "1002"}],
    artLiked: [{id: "103"}, {id: "105"}],
    sketchbooksLiked: [{id: "13"}, {id: "15"}],
    critiquesLiked: [{id: "1004"}, {id: "1005"}],
    followers: [{id: "2"}, {id: "3"}, {id: "4"}, {id: "5"}],
    following: [{id: "2"}, {id: "4"}],
  }, {
    id: "2",
    createdOn: new Date().getTime(),
    ...
    artCreated: [],
    sketchbooksCreated: [{id: "12"}],
    critiquesCreated: [{id: "1003"}],
    artLiked: [{id: "101"}, {id: "102"}],
    sketchbooksLiked: [{id: "11"}],
    critiquesLiked: [{id: "1001"}, {id: "1002"}, {id: "1005"}],
    followers: [{id: "1"}],
    following: [{id: "1"}, {id: "4"}],
  }, {
    id: "3",
    ...
    artCreated: [{id: "103"}],
    sketchbooksCreated: [{id: "13"}],
    critiquesCreated: [{id: "1004"}, {id: "1005"}],
    artLiked: [{id: "102"}],
    sketchbooksLiked: [{id: "12"}],
    critiquesLiked: [{id: "1001"}],
    followers: [{id: "5"}],
    following: [{id: "1"}, {id: "4"}],
  }, {
    id: "4",
    ...
    artCreated: [],
    sketchbooksCreated: [{id: "14"}],
    critiquesCreated: [],
    artLiked: [],
    sketchbooksLiked: [{id: "12"}],
    critiquesLiked: [{id: "1005"}],
    followers: [{id: "1"}, {id: "2"}, {id: "3"}, {id: "5"}],
    following: [{id: "1"}],
  }, {
    id: "5",
    createdOn: new Date().getTime(),
    ...
    artCreated: [{id: "104"}, {id: "105"}],
    sketchbooksCreated: [{id: "15"}],
    critiquesCreated: [],
    artLiked: [{id: "101"}],
    sketchbooksLiked: [],
    critiquesLiked: [{id: "1001"}, {id: "1002"}, {id: "1005"}],
    followers: [],
    following: [{id: "1"}, {id: "3"}, {id: "4"}],
  }
];
